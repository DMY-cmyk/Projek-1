...
$dashboard += "Column reference in `outputs/data_dictionary.md` (run `scripts/build_data_dictionary.ps1`)."
$dashboard += ""
$dashboard += "## Release Notes"
$dashboard += "Latest changes in `outputs/release_notes.md` (run `scripts/build_release_notes.ps1`)."
$dashboard += ""
$dashboard += "## Benchmark Snapshot"
$dashboard += "Peer snapshot in `outputs/benchmark_snapshot.md` (run `scripts/build_benchmark_snapshot.ps1`)."
$dashboard += ""
$dashboard += "## Benchmark History"
$dashboard += "Append history to `outputs/benchmark_history.csv` (run `scripts/append_benchmark_history.ps1`)."
$dashboard += ""
