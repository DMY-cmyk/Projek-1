param(
    [string]$LogPath = "outputs/run_log.md"
)
...
$steps.Add((Run-Step "Sanity checks" "scripts/build_sanity_checks.ps1")) | Out-Null
...
$steps.Add((Run-Step "Print tool versions" "scripts/print_versions.ps1")) | Out-Null
...
Write-Host "Done. Wrote run log to $LogPath."
